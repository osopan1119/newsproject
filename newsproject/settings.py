...
DEFAULT_FROM_EMAIL = 'mro2423021@stu.o-hara.ac.jp'  # メールの送信元のアドレスを入力
EMAIL_HOST = 'mro2423021@stu.o-hara.ac.jp'            # GmailのSMPTサーバー　　　
EMAIL_PORT = 587                         # SMPTサーバーのポート番号
EMAIL_HOST_USER = 'mro2423021@stu.o-hara.ac.jp'     # Gmailのアドレスを入力
EMAIL_HOST_PASSWORD = 'Km338700' # Gmailのアプリ用パスワードを入力
